        ...
        return (
            <table id='syndicate-table' onClick={this.props.onClick}>
                ...
                <tr>
                    ...
                    <BetrayalTableCell img={'assets/encounters/aisling/3research.png'} alt={'Research'} description={"Timed crafting spree for a normal boot"} id={'t31'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 1]}/>
                    <BetrayalTableCell img={'assets/encounters/cameria/3research.png'} alt={'Research'} description={"Timed crafting spree for a normal ring"} id={'t32'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 2]}/>
                    <BetrayalTableCell img={'assets/encounters/elreon/3research.png'} alt={'Research'} description={"Timed crafting spree for a normal shield"} id={'t33'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 3]}/>
                    <BetrayalTableCell img={'assets/encounters/gravicius/3research.png'} alt={'Research'} description={"Timed crafting spree for a normal body armour"} id={'t34'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 4]}/>
                    <BetrayalTableCell img={'assets/encounters/guff/3research.png'} alt={'Research'} description={"Timed crafting spree for a normal glove"} id={'t35'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 5]}/>
                    <BetrayalTableCell img={'assets/encounters/haku/3research.png'} alt={'Research'} description={"22/24/26/28 armour Quality"} id={'t36'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 6]}/>
                    <BetrayalTableCell img={'assets/encounters/hillock/3research.png'} alt={'Research'} description={"Timed crafting spree for a normal belt"} id={'t37'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 7]}/>
                    <BetrayalTableCell img={'assets/encounters/it_that_fled/3research.png'} alt={'Research'} description={"Timed crafting spree for a magic jewel"} id={'t38'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 8]}/>
                    <BetrayalTableCell img={'assets/encounters/janus/3research.png'} alt={'Research'} description={"Chest containing item with white sockets"} id={'t39'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 9]}/>
                    ...
                    <BetrayalTableCell img={'assets/encounters/korell/3research.png'} alt={'Research'} description={"Timed crafting spree for a normal"} id={'t311'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 11]}/>
                    <BetrayalTableCell img={'assets/encounters/leo/3research.png'} alt={'Research'} description={"22/24/26/28 quality flask"} id={'t312'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 12]}/>
                    <BetrayalTableCell img={'assets/encounters/riker/3research.png'} alt={'Research'} description={"Chest containing a fractured item"} id={'t313'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 13]}/>
                    <BetrayalTableCell img={'assets/encounters/rin/3research.png'} alt={'Research'} description={"22/24/26/28 quality Maps"} id={'t314'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 14]}/>
                    <BetrayalTableCell img={'assets/encounters/tora/3research.png'} alt={'Research'} description={"Chest containing support Gem"} id={'t315'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 15]}/>
                    <BetrayalTableCell img={'assets/encounters/vagan/3research.png'} alt={'Research'} description={"22/24/26/28 weapon quality"} id={'t316'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 16]}/>
                    <BetrayalTableCell img={'assets/encounters/vorici/3research.png'} alt={'Research'} description={"10/15/20/30 reforge link"} id={'t317'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 17]}/>
                </tr>
                <tr>
                    ...
                    <BetrayalTableCell img={'assets/encounters/cameria/4intervention.png'} alt={'Intervention'} description={"Chest containing rare items"} id={'t42'} colourID={this.state.selected[TABLE_COL_SIZE*4 + 2]}/>
                    ...
                    <BetrayalTableCell img={'assets/encounters/gravicius/4intervention.png'} alt={'Intervention'} description={"Chest containing 6-socketed items"} id={'t44'} colourID={this.state.selected[TABLE_COL_SIZE*4 + 4]}/>
                    <BetrayalTableCell img={'assets/encounters/guff/4intervention.png'} alt={'Intervention'} description={"Timed crafting spree for a normal weapon"} id={'t45'} colourID={this.state.selected[TABLE_COL_SIZE*4 + 5]}/>
                    ...
                    <BetrayalTableCell img={'assets/encounters/jorgin/4intervention.png'} alt={'Intervention'} description={"Timed crafting spree for a normal amulet"} id={'t410'} colourID={this.state.selected[TABLE_COL_SIZE*4 + 10]}/>
                    ...
                    <BetrayalTableCell img={'assets/encounters/rin/4intervention.png'} alt={'Intervention'} description={"Chest containing fully linked items"} id={'t414'} colourID={this.state.selected[TABLE_COL_SIZE*4 + 14]}/>
